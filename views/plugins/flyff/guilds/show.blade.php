        ...
        <div class="table-responsive">
            <table class="table table-striped" data-aos="fade-up">
                ...
                @foreach ($guild->members as $member)
                    <tr>
                        <th scope="row"><img style="width: 64px;height:64px" src="{{$member->character->AvatarUrl}}"
                                             alt=""></th>
                        ...
                        <td><img src="{{$member->character->JobIcon}}"
                                 alt="{{$member->character->JobName}}"> {{$member->character->JobName}}</td>
